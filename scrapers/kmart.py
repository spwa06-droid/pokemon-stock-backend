...
async def check_kmart(query: str, proxies=None):
    url = f"https://www.kmart.com.au/search?query={query}"
    ...
    async with aiohttp.ClientSession() as session:
        ...
        for product in soup.select('.product-tile'):
            ...
            items.append({
                ...
                "url": "https://www.kmart.com.au" + link['href'] if link and link.get('href') else url
            })
        return items
