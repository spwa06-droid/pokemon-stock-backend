...
async def check_target(query: str, proxies=None):
    url = f"https://www.target.com.au/search?query={query}"
    ...
    async with aiohttp.ClientSession() as session:
        ...
        for product in soup.select('.product-tile'):
            ...
            items.append({
                ...
                "url": "https://www.target.com.au" + link['href'] if link and link.get('href') else url
            })
        return items
